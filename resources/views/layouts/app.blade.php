...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        <header class="flex items center justify-between px-8 py-4">
            <a href="#"><img src="{{ asset('logo.svg') }}" alt="Laracasts Logo"></a>
            ...
            @endif
                <a href="#">
                    <img src="https://www.gravatar.com/avatar/000000000000000000000000000?d=mp" alt="avatar" class="w-10 h-10 rounded-full">
                </a>
            </div>
        </header>
            ...
            <div class="w-70 mr-5">
                <div 
                    ...
                    <div class="text-center px-6 py-2 pt-6">
                        ...
                        <p class="text-xs mt-4">Let us know what you like and we'll take a look over!</p>
                    </div>

                    <form action="#" method="post" class="text-sm space-y-4 px-4 py-6">
                        <div>
                            <input type="text" class="text-sm w-full border-none bg-gray-100 rounded-xl placeholder-gray-900 px-4 py-2" placeholder="Your Idea">
                        </div>
                        ...
                        <div class="flex items-center justify-between space-x-3">
                            <button class="flex items-center justify-center w-1/2 h-11 text-xs bg-gray-200 
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-600 w-4 transform -rotate-45" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13" />
                                                    </svg><span class="ml-1">Attach</span>
                            </button>

                            <button class="flex items-center justify-center w-1/2 h-11 text-xs bg-blue hover:bg-blue-hover
                            font-semibold rounded-xl border border-blue
                            transition duration-150 ease-in px-6 py-3" type="submit">
